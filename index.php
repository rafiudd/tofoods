              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    <h1>
                      Telkom Fast Food canteen 
                    </h1>
                    <p>
                     Penyedia layanan pembelian dan juga jasa antar makanan di area IT Telkom Purwokerto
                    </p>
                    <div class="btn-box">
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Ultramilk Team Berkontribusi dalam semua aspek pembuatan Website dan pengembangan website untuk kepentingan Tugas Besar UTS Pemrograman Web
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Order Now
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="images/ketupat.png" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Ketupat
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                Makanan nya murah murah,cocok untuk mahasiswa dan pelayanan nya cepat,utnuk metode pembayaran juga lengkap
                </p>
                <h6>
                  Andina Nur Lifiasari
                </h6>
                <p>
                  Mahasiswi ITTP
                </p>
              ...
              <div class="img-box">
                <img src="images/ayg.jpeg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                 Pelayanan nya cepat dan menunya banyak pilihan serta penjualnya ramah
                </p>
                <h6>
                  Maria Yemisu Mawascinta
                </h6>
                <p>
                  Mahasiswi ITTP
                </p>
              ...
              <div class="img-box">
                <img src="images/cinta.jpeg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
